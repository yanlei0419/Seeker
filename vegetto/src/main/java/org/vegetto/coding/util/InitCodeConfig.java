...
public class InitCodeConfig {
	...
	public static final String pdm_path = "D:\\sql\\DdhccEHR.pdm";
	//生成的xml文件路径(完成的硬盘路径,不能包含中文字符)
	public static final String xml_path = "D:\\tables.xml";
	//生成的jsp\java文件路径(完成的硬盘路径)
//	public static final String jsp_path = "D:\\coding\\V_Book";
	public static final String jsp_path = "D:\\jsp\\";
