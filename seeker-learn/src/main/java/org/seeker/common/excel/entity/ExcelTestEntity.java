...
import org.seeker.common.excel.Excel;
...
//	private Double dqzfje;
	...
	public String toString(){
		return this.acId+this.brName+this.brNo+this.businessNo+this.curNo+this.cusName+this.custNo+this.dqjgr+this.empName
				+this.jyfx+this.khjl+this.kmh+this.orgnlbusntyp+this.ph+this.prdtName+this.prdtNo+this.sqjgr;
	}
