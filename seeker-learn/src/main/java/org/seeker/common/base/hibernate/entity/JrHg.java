...
//	@Excel(exportName="ҵ������",exportFieldWidth=32,exportConvertSign=0, importConvertSign=0)
	...
	private String jyfx;
	@Excel(exportName="���ڽ�����",exportFieldWidth=32,exportConvertSign=0, importConvertSign=0)
	...
	private String khjl;*/
	@Excel(exportName="�ع�����(��%)",exportFieldWidth=32,exportConvertSign=0, importConvertSign=0)
	private Double hglv;
	@Excel(exportName="����Ա���",exportFieldWidth=32,exportConvertSign=0, importConvertSign=0)
	private String khjl;
